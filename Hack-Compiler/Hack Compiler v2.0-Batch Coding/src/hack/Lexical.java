			...
			BufferedReader br = new BufferedReader(new FileReader(f));
                        ...
                        if (HackXDefine.isAnumb(s)){
                          ...
                          /*  if (st.nextToken()==StreamTokenizer .TT_WORD){
                            if ((HackXDefine.isAnID(st.sval))&&st.sval.compareTo("to")!=0)
                                 System.out.println("Lexical Error: Invalid id name at line "+st.lineno());
                           {try{new Error ("Lexical Error: Invalid id name at line "+st.lineno());} catch(Exception e){}}
...
Syntax.start();
Syntax.codeG=Syntax.codeG+("echo.\n");
Syntax.codeG=Syntax.codeG+("echo.\n");
Syntax.codeG=Syntax.codeG+("echo END Of Execution\n");
Syntax.codeG=Syntax.codeG+("echo.\n");
Syntax.codeG=Syntax.codeG+("echo.\n");
Syntax.codeG=Syntax.codeG+("pause\n");
if(Syntax.syntaxDONE&& LexicalDone )
{HackGUI.generateCode(Syntax.codeG);
System.out.println(Syntax.nestedloops);
